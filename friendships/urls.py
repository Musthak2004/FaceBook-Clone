...
urlpatterns = [
    ...
    path('requests/send/<int:pk>/', views.SendRequestView.as_view(), name='send_request'),
    path('requests/accept/<int:pk>/', views.AcceptRequestView.as_view(), name='accept_request'),
    path('requests/reject/<int:pk>/', views.RejectRequestView.as_view(), name='reject_request'),
